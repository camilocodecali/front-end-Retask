...
export const profileSchema = authSchema
  .pick({
    name: true,
    lastName: true,
    phone: true,
...
export const userTableSchema = authSchema
  .pick({
    name: true,
    lastName: true,
    identification: true,
...
export type TaskFormData = Pick<
  Task,
  "taskName" | "taskDescription" | "startDate" | "endDate" | "folderProject"
>;
export type TaskProject = z.infer<typeof taskProjectSchema>;
/**Team */
export const teamMemberSchema = authSchema
  .pick({
    name: true,
    lastName: true,
    email: true,
...
export type ProjectFormData = Pick<
  ...
  | "folderProject"
>;
export type ProjectTableData = Pick<
  Project,
  "_id" | "projectName" | "startDate" | "clientName" | "endDate" | "manager"
>;
