            ...
            >
              <Dialog.Panel className="w-full max-w-4xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all p-16">
                ...
                <p className="text-xl font-bold">
                  ...
                  <span className="text-bg-second">colocando tu password</span>
                </p>
                ...
                >
                  ...
                  <input
                    type="submit"
                    className=" bg-bg-second hover:bg-blue-500 w-full p-3  text-white font-black  text-xl cursor-pointer"
